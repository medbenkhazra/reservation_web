        ...
        <div class="navbar-menu-wrapper d-flex align-items-top">
          <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
              <h1 class="welcome-text">Bonjour, <span class="text-black fw-bold"> <%= request.getSession().getAttribute("username") %></span></h1>
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  ...
                  <p class="mb-1 mt-3 font-weight-semibold"><%= request.getSession().getAttribute("username") %></p>
                ...
                <a class="dropdown-item" href="signOut.jsp"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</a>
              </div>
            </li>
          </ul>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="content" method="post">
                   ...
                   <!--    <input type="text" class="form-control"  name="heureDebut" id="heureDebut" 
                        aria-describedby="emailHelp" placeholder="Enter l'heure de debut"> -->

                        <input id="heureDebut" type="time" name="heureDebut" step="1" value=""  required=""/>
                    </div>
                    <div class="form-group col">
                      <label for="exampleInputPassword1">heure de fin :</label>
                 <!--      <input type="text" class="form-control" name="heureFin" id="heureFin" 
                        placeholder="Entrer l'heure de fin"> -->
                        <input id="heureFin" type="time" name="heureFin" step="1" value=""  required=""/> 
                    </div>
                  </div>

                   <div class="text-center">
                    <button id="add"  type="submit" class="btn btn-primary text-center">Envoyer</button>
                   </div>
